...
class TestBulletListsInDocx(unittest.TestCase):
    def test_unordered_markdown_lists_become_word_bullets(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(styles[0], "List Bullet")
            self.assertEqual(styles[1], "List Bullet 2")
            self.assertEqual(styles[2], "List Bullet")
